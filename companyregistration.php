    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCompanies" action="jobPortal/addcompany.php" enctype="multipart/form-data">
...
<!-- AdminLTE App -->
<script src="jobPortal/js/adminlte.min.js"></script>
