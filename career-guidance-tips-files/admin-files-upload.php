								...
								<table cellpadding="0" cellspacing="0" border="0" class="table table-condensed" id="example">
									...
									<thead>
										...
										<tr>
											...
											<th style="color:#751b8f;font-weight:bolder;font-size:15px">Delete</th>
											<th style="color:#751b8f;font-weight:bolder;font-size:15px">Publish</th>
									...
									<tbody>
										...
										?>
											...
											<tr>
												...
												<td>
													<a href="file-delete.php?del=<?php echo $row['id'] ?>"><span class="glyphicon glyphicon-trash" style="font-size:20px; color:red"></span></a>
												</td>

												<td>
													<a href="publish.php?del=<?php echo $row['id'] ?>"><span class="glyphicon glyphicon-upload" style="font-size:20px; color:green"></span></a>
												</td>
											</tr>
