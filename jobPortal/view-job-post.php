            ...
            <div class="container">
              <div class="row">
                <div class="col-md-9 bg-white padding-2">
                  ...
                  <hr>
                  <div>
                    <p><span class="margin-right-10"><i class="fa fa-location-arrow text-purple"></i> <?php echo $row['city']; ?></span> <i class="fa fa-calendar text-purple"></i> <?php echo date("d-M-Y", strtotime($row['createdat'])); ?></p>
                  </div>
                  <div>
                ...
                <div class="col-md-3">
                  <div class="thumbnail">
                    ...
                    <div class="caption text-center">
                      ...
                      <button class="btn btn-primary btn-flat" onclick="myFunction()">Help</button>
