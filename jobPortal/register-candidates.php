    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          <h1 class="text-center margin-bottom-20">COMPLETE YOUR JOB PROFILE</h1>
          <h4 style="color: red;font-weight:bolder;text-align:center;">*Please enter the same details you entered when you are registering in the Career NextGen Web Application to avoid complications</h4>
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <textarea class="form-control input-lg" rows="4" id="aboutme" name="aboutme" placeholder="Brief introduction about yourself *" required></textarea>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="stream" name="stream" placeholder="Stream/Field">
              </div>                    
              <div class="form-group checkbox">
                <label><input type="checkbox"> I accept terms & conditions</label>
              </div>
              <div class="form-group">
                <button style="background-color:purple" class="btn btn-flat btn-success">Save</button>
              </div>
              <?php 
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                ...
                <input type="file" name="resume" class="btn btn-flat btn-warning" required>
              </div>
            </div>
          </form>
