    ...
    <nav class="navbar navbar-static-top">
      ...
      <div style="background-color: purple;" class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          ?>        
          <li>
            <a style="color: white;" href="company/index.php">Dashboard</a>
          </li>
          <?php } ?>
          <li>
  ...
  <div class="content-wrapper" style="margin-left: 0px;">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center index-head">
            <h1>Welcome To <strong>Caeer NextGen</strong> Job Portal</h1>
            <p>Create A Better Future For Yourself</p>
            <p><a class="btn btn-success btn-lg" style="background-color:purple ;" href="jobs.php" role="button">Search Jobs</a></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="about" class="content-header">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <img src="img/job-search2.jpg" class="img-responsive">
          </div>
