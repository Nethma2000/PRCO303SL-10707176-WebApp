      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="index.php"><i style="color: purple;" class="fa fa-address-card-o"></i> My Applications</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2 style="color: purple;"><i><b>Applied Jobs </b></i></h2>
            <p>The status of the jobs you have applied for are listed below</p>
