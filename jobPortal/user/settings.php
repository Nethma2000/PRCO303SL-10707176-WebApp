      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  <li><a href="edit-profile.php"><i style="color: purple;" class="fa fa-user"></i> Edit Profile</a></li>
                  ...
                  <li class="active"><a href="settings.php"><i style="color: purple;" class="fa fa-gear"></i> Settings</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2 style="color: purple;"><i><b>Change Password</b></i></h2>
            <p style="color: red;"><b>*If you change the password from here, it will apply only to your job portal login.<br>
              Then you will have to remember two passwords for the main login of<br> Career NextGen web application and for the job portal
            </b></p>
            <div class="row">
              <div class="col-md-6">
                <form id="changePassword" action="change-password.php" method="post">
                  ...
                  <div class="form-group">
                    <button type="submit" style="background-color: #5c0637;color:white;font-size:large" class="btn btn-flat btn-">Change Password</button>
                  </div>
              ...
              <div class="col-md-6">
                <form action="deactivate-account.php" method="post">
                  ...
                  <button type="submit" style="background-color: #990505;color:white" class="btn btn- btn-flat btn-lg">Deactivate My Account</button>
                </form>
              </div>
            </div>
