          ...
          <div class="col-md-3">
            <div class="box box-solid">
              ...
              <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="job-applications.php"><i style="color:#8910ad ;" class="fa fa-check-square"></i> Job Applications Received</a></li>
               ...
               $sql = "SELECT * FROM users WHERE id_user='$_GET[id]'";
                ...
                <div>
                  <?php
                    ...
                    echo 'City: '.$row['city'];
                    echo '<br>';
                    echo 'Highest qualification: '.$row['qualification'];
                    echo '<br>';
                  ...
                  <div class="row">
                    <div class="col-md-3 pull-left">
                      <a href="under-review.php?id=<?php echo $row['id_user']; ?>&id_jobpost=<?php echo $_GET['id_jobpost']; ?>" class="btn btn-success">Shortlist</a>
                    </div>
