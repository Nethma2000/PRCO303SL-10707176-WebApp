      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <div class="box box-solid">
              ...
              <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="resume-database.php"><i style="color:#8910ad ;" class="fa fa-user"></i> Resume Database</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2 style="color: purple;"><i><b>Resume Database</b></i></h2>
