      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <div class="box box-solid">
              ...
              <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="create-job-post.php"><i style="color:#8910ad ;" class="fa fa-plus-square"></i> Add Job Vacancy</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2 style="color: purple;"><i><b>Create Job Vacancy</b></i></h2>
            <div class="row">
              <form method="post" action="addpost.php">
                ...
                <input type="number" class="form-control  input-lg" id="experience" autocomplete="off" name="experience" placeholder="Experience (in Years) Required" required="">
                  ...
                  <div class="form-group">
                    <button style="background-color: purple;color:white" type="submit" class="btn btn-flat btn-success">Save</button>
                  </div>
                </div>
              </form>
            </div>
