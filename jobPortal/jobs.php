    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a style="color: white;" href="register-candidates.php">Job Seeker Profile</a>
          </li>  
          <?php } else { 
          ...
          ?>        
          <li>
            <a style="color: white;" href="user/index.php">Dashboard</a>
          </li>
          <?php
          } else if(isset($_SESSION['id_company'])) { 
          ?>        
          <li>
            <astyle="color: white;"  href="company/index.php">Dashboard</a>
          </li>
          <?php } ?>
          <li>
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    <a href="#"><i style="color: purple;" class="fa fa-building"></i> City <span class="pull-right"><i class="fa fa-angle-down pull-right"></i></span></a>
                    <ul class="treeview-menu">
                      <li><a href="" style="color: black;"  class="citySearch" data-target="Colombo"><i style="color: purple;" class="fa fa-circle-o"></i> Colombo</a></li>
                      <li><a href="" style="color: black;" class="citySearch" data-target="Kandy"><i style="color: purple;" class="fa fa-circle-o"></i> Kandy</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
